define(['jquery', 'video', 'vidinfo'], function($, video, vidinfo) {
	function random(obj) {
		return Math.floor(Math.random() * (obj.items.length + 1));
	}

	$.get("https://www.googleapis.com/youtube/v3/videos?part=snippet&chart=mostPopular&maxResults=50&fields=items(contentDetails%2Cid%2Csnippet)&key=AIzaSyAG6QJDbA_oM94AIB618d4cQcjikQlWBQY", function(response) {
